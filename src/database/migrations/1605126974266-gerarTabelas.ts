...
export class gerarTabelas1605126974266 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tournaments" ALTER COLUMN "participants" DROP NOT NULL`,
    )
    await queryRunner.query(
      `ALTER TABLE "tournaments" ALTER COLUMN "rounds_ids" DROP NOT NULL`,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tournaments" ALTER COLUMN "rounds_ids" SET NOT NULL`,
    )
    await queryRunner.query(
      `ALTER TABLE "tournaments" ALTER COLUMN "participants" SET NOT NULL`,
    )
    await queryRunner.query(`ALTER TABLE "tournaments" DROP COLUMN "end_date"`)
    await queryRunner.query(
