...
export class gerarTabelas1605112318371 implements MigrationInterface {
  name = 'gerarTabelas1605112318371'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "matchs" ADD CONSTRAINT "UQ_4b11f292258ee81f4e065ef9e15" UNIQUE ("tournament_id")`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "matchs" ADD CONSTRAINT "FK_4b11f292258ee81f4e065ef9e15" FOREIGN KEY ("tournament_id") REFERENCES "tournaments"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "matchs" DROP CONSTRAINT "FK_4b11f292258ee81f4e065ef9e15"`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "matchs" DROP CONSTRAINT "UQ_4b11f292258ee81f4e065ef9e15"`,
    )
    await queryRunner.query(
